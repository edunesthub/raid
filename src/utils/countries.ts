 ...
 * @param {string} countryName - Country name
 * @returns {object} Country object with code, name, and flag
 */
export const getCountryInfo = (countryName: string | undefined): any => {
    const country = COUNTRIES.find(c => c.name === countryName);
    return country || { code: 'XX', name: countryName || 'Unknown', flag: '🌍' };
};
