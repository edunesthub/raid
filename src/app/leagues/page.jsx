...
export default function LeaguesPage() {
    ...
    if (view === 'list') {
        return (
            <div className="h-[100dvh] bg-[#050505] flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-4 pb-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 scrollbar-hide">
                    {leagueList.map((league) => (
                        <div
                            key={league.id}
                            onClick={() => handleSelectLeague(league)}
                            className="group relative bg-[#0a0a0a] border border-white/5 rounded-2xl p-4 hover:border-orange-500/50 transition-all cursor-pointer overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 space-y-2.5">
                                <div className="flex items-center gap-3">
                                    {/* Icon/Image */}
                                    <div className="shrink-0 w-12 h-12 rounded-lg bg-orange-500/10 flex items-center justify-center border border-orange-500/20 group-hover:bg-orange-500 group-hover:text-white transition-all overflow-hidden relative font-bold text-orange-500 group-hover:text-white">
                                        {league.league_flyer ? (
                                            <Image
                                                src={league.league_flyer}
                                                alt="Icon"
                                            ...
                                            <Trophy size={20} className="text-orange-500 group-hover:text-white" />
                                        )}
                                    </div>

                                    {/* Title & Season */}
                                    <div className="flex-1 min-w-0 pr-1">
                                        <h3 className="text-base font-bold text-white uppercase tracking-tight leading-tight truncate">{league.name}</h3>
                                        <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest">{league.season}</p>
                                    </div>

                                    {/* View Arrow */}
                                    <div className="shrink-0 text-white/20 group-hover:text-orange-500 transition-colors">
                                ...
                                <div className="pt-2.5 flex items-center justify-between border-t border-white/5">
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black text-gray-600 uppercase tracking-wider">Prize Pool</span>
                                        <span className="text-[10px] font-bold text-orange-500 leading-none mt-0.5">{league.prize_pool}</span>
                                    </div>
                                    <div className="flex flex-col items-end text-right">
                                        <span className="text-[7px] font-black text-gray-600 uppercase tracking-wider">Entry Close</span>
                                        <span className="text-[10px] font-bold text-white leading-none mt-0.5">{league.start_date}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <div className="h-[100dvh] bg-[#050505] overflow-y-auto relative">
            {/* --- Back Button --- */}
            <div className="fixed top-24 left-4 z-[60] md:left-8">
                <button
                    onClick={() => setView('list')}
                    className="flex items-center gap-2 bg-black/40 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full text-white font-black text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all shadow-lg"
                >
            ...
            <div className="pt-20 pb-4 md:pb-8 bg-gradient-to-b from-orange-500/10 to-transparent border-b border-white/5 relative z-10">
                ...
                {/* --- Main Content Area --- */}
                <div className="md:container-mobile pb-24 min-h-screen">
